    ...
    if(message.content[0] == prefix){
        ...
        switch(arg[0].toLowerCase()){
            ...
            case 'help':
                ...
                helptxt += "\t\t-Eg: ?op N:1111 E:22222 2 30 <----- Here the 1st two arguments are reserved for the origin cordinates, the 2nd argument stands for the ETA(friendly) and the 3rd argument stands for the Angle in counterclockwise fashion.\n"
